...
% System parameters
params.bandwidth = 256*30e3/1e9;     % The bandwidth in GHz, 256 subcarriers with 30khz spacing
...
% OFDM parameters
params.num_OFDM = 256;                % Number of OFDM subcarriers: 1024 subcarriers
...
params.OFDM_limit = 256;               % Only the first params.OFDM_limit subcarriers will be considered  
