...
if __name__ == "__main__":
    ...
    for i in range(1,10):
        ...
        savemat(
        "result_new_data_3/all_nmse_combine_select"+str(i)+".mat",
        {"all_nmse_combine_select"+str(i): all_nmse},
        )
        all_all_nmse.append(all_nmse)
    all_all_nmse = np.stack(all_all_nmse, 0)
    print(all_all_nmse)
    savemat(
        "result_new_data_3/all_nmse_combine_select.mat",
        {"all_nmse_combine_select": all_all_nmse},
    )
    print("done")
